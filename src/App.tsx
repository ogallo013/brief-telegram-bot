...
export function App() {
  ...
  return (
    <div className="min-h-screen bg-[#09150E] text-[#E2ECE5] flex flex-col font-sans selection:bg-[#00FF42] selection:text-[#09150E]">
      ...
      {/* Toast */}
      {toastMessage && (
        <div role="status" className="fixed bottom-6 right-6 z-50 bg-[#00FF42] text-[#09150E] px-4 py-2.5 rounded-xl font-extrabold shadow-2xl flex items-center gap-2 animate-in fade-in">
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-4 sm:px-6 py-6">
        ...
        <div className="mb-6 rounded-2xl bg-[#102117] border border-[#235F45] p-5 shadow-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 font-mono text-xs font-extrabold z-10">
        ...
        {activeTab === 'stream' && (
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-2 overflow-x-auto pb-1 no-scrollbar" role="tablist" aria-label="Object Categories">
              <button
      ...
      <footer className="border-t border-[#1E3A2A] mt-12 py-6 text-xs text-[#86935C] text-center font-mono">
        Brief 10.0 • 80% Visual / 20% Text • Functional Local OS
      </footer>
